package com.github.jzhongming.udplog.commons;
...
public class UdpClientSocket {
	...
	public UdpClientSocket(String localhost, int port) throws Exception {
		dgs = new DatagramSocket(port, InetAddress.getByName(localhost));
	}
